...
export const sounds = [
  { id: 'tea', title: '茶香', category: '生活', subtitle: '茶与安静器皿', audioFileName: 'tea.mp3', backgroundPath: `${cloudAudio.fileIdPrefix}/backgrounds/tea.jpg`, theme: 'forest' },
  ...
  { id: 'day', title: '白昼', category: '氛围', subtitle: '明亮自然环境', audioFileName: 'day.mp3', backgroundPath: `${cloudAudio.fileIdPrefix}/backgrounds/day.jpg`, theme: 'sunset' },
